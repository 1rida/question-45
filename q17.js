...
var guestList = ["afshan", "kehkashan", "darakhshan", "gurya"];
var guest1 = guestList.pop();
var guest2 = guestList.pop();
console.log("\n".concat(guest1, " i can't invite you for dinner"));
console.log("\n".concat(guest2, " i can't invite you for dinner"));
var guest3 = "kehkashan";
var guest4 = "afshan";
console.log("".concat(guest3, " you are still invited for dinner"));
console.log("".concat(guest4, " you are still invited for dinner"));
