...
function make_album(artist_name:string, album_title:string , track?:number){
    let Album :{name:string , album:string , track?:number}={
name:artist_name,
album:album_title,
track : track,
    }
...
console.log(make_album("samina","butterfly"));
console.log(make_album("huma","touch the sky"));
console.log(make_album("hina","sparrow", 45));