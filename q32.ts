...
let current_users = ["neha","noorjahan","meena","samina","ayesha"]

for(let i=0;i<current_users.length;i++){

let new_users = ["neha", "noorjahan","yusra", "hiba","fatima"]

for(let i=0 ; i<new_users.length ; i++){

    if(current_users[i] ==(new_users[i])){
 
console.log(`the person will need to enter a new user name`)
